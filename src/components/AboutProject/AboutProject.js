    ...
    <section className='about' ref={projectRef}>
      <div className='about__content'>
        ...
        <div className='about__deadline'>
          ...
          <p className='about__description about__description-title_type_work'>Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
          <p className='about__description about__description-title_type_deadline'>У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
        </div>
