...
function Profile({
  ...
  useEffect(() => {
    if ((changeName === currentUser.name && changeEmail !== currentUser.email) || (changeName !== currentUser.name && changeEmail === currentUser.email) || (changeName !== currentUser.name && changeEmail !== currentUser.email)) {
      setFormValid(true);
    } else {
      setFormValid(false)
    }
